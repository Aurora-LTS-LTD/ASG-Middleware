...
# ═════════════════════════════════════════════════════════════════════
# Appendix J Sprint 3 — AI Copilot Console (Headline K)
# ═════════════════════════════════════════════════════════════════════
# Endpoints:
...
#   POST /api/v1/admin/exec/copilot/chat (SSE)               — stream turn
#   POST /api/v1/admin/exec/copilot/approve                  — exec tool
#
# Provisioning gating: /approve requires WebAuthn step-up token bound to
# action="copilot_provision" (or AURORA_EXEC_REQUIRE_STEP_UP=0 escape).
#
# Rate limit: max AURORA_COPILOT_MAX_TURNS_PER_HOUR=30 chat turns per
# user per rolling 60min window.
...
# ═════════════════════════════════════════════════════════════════════
# Copilot — Budget guardrails admin endpoints (Appendix K §1C)
# ═════════════════════════════════════════════════════════════════════
