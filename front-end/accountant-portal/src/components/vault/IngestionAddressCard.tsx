...
function CopyButton({ value }: { value: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="ml-2 rounded p-1 text-zinc-500 transition-colors hover:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          ...
          <div className="flex items-center justify-between rounded-lg border border-zinc-800 bg-zinc-950 px-3 py-2.5">
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-[10px] font-medium uppercase tracking-wide text-zinc-500">Email</p>
                <p className="truncate text-sm font-mono text-zinc-200">{data.email_full}</p>
              </div>
            </div>
          ...
          {data.whatsapp_display ? (
            <div className="flex items-center justify-between rounded-lg border border-zinc-800 bg-zinc-950 px-3 py-2.5">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-[10px] font-medium uppercase tracking-wide text-zinc-500">WhatsApp</p>
                  <p className="text-sm font-mono text-zinc-200">{data.whatsapp_display}</p>
                </div>
              </div>
